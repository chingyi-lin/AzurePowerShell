# Notes: The original version is here: https://github.com/Azure/azure-powershell/blob/dev/src/ResourceManager/Compute/Commands.Compute/Extension/AzureDiskEncryption/Scripts/AzureDiskEncryptionPreRequisiteSetup.ps1
...
########################################################################################################################
    ...
    Get-AzureRmSubscription –SubscriptionName “Azure Pass” | Select-AzureRmSubscription
